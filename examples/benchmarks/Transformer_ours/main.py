...
if __name__ == "__main__":
    ...
    for seed in range(0, 10):
        ...
        if not args.only_backtest:
            model.fit(dataset=dataset, save_path=f"./model/{basic_config['market']}transformer_{seed}.pkl")
        else:
            model.load_model(f"./model/{basic_config['market']}transformer_{seed}.pkl")
