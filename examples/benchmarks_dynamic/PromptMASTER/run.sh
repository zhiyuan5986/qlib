...
if $only_backtest; then
    ...
    nohup python -u main.py --universe $universe --mprompts $mprompts --nprompts $nprompts --lenprompts $lenprompts --online_lr $online_lr > ./logs/${universe}online_lr${online_lr}mprompts${mprompts}_nprompts${nprompts}_lenprompts${lenprompts}_lamb0.5.log 2>&1 &
fi
echo $!