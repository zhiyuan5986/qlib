...
with open('./pkl_data/dataset.pkl', 'rb') as f:
    data = pickle.load(f)
dataset = data[0]
...
with open('./pkl_data/base_models.pkl', 'rb') as f: feature_data = pickle.load(f)
with open('./pkl_data/label.pkl', 'rb') as f: label = pickle.load(f)

with open('./pkl_data/model_weight.pkl', 'rb') as f: model_weight = pickle.load(f).values
...
methods = {
    ...
    'Ours': (model_weight * X).sum(axis=1),
}
